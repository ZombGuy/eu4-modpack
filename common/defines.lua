NDefines = { -- Changes 1.0 POWER_MAX = 9999 -- Default 999
...
NCountry = {
	...
	PARLIAMENT_RESET_COOLDOWN = 10,				-- how long before you can use reset again for parliament decisions
...
NEconomy = {
	...
	CARAVAN_POWER_MIN = 2,
	MAX_BUILDING_SLOTS = 50,						-- Maximum number of buildings slots, i.e. max buildings possible.
